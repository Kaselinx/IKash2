...
//	private static final String ENTITY_PACKAGE = "com.taiwanlife.ikash.backend.entity.ikash" ;
//	
//	
//	/**
//	 * Constructor
//	 */
//	public IKashJpaConfig ()
//	{
//		super () ;
//		log.info ( "**** JpaConfig : {}", this.getClass ().getName () ) ;
//	}
//
//	@Bean (name = "ikashdataSourceMSSQL")
//	@Primary
...
//	public LocalContainerEntityManagerFactoryBean entityManagerFactory (@Qualifier("ikashdataSourceMSSQL") DataSource ds)
//	{
//		dataSource = ds;
//
